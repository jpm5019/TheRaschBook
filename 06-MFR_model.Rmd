...
In the next section, we provide a step-by-step demonstration of a MFRM analysis using the *TAM* package [@TAM] for R. We encourage readers to use the example data set for this chapter that is provided in the online supplement to conduct the analysis along with us.
...
In the next section, we provide a step-by-step demonstration of a MFRM analysis using the TAM package [@TAM] for R for data that are stored in *long format*. We encourage readers to use the example data set for this chapter that is provided in the online supplement to conduct the analysis along with us.
