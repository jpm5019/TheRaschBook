...
This chapter provides a basic overview of procedures for evaluating rating scales with Rasch models using R. We will use the eRm package (Mair et al., 2020) and the TAM package (Robitzch et al., 2020) for the analyses in this chapter. We use example data from an attitude survey to demonstrate procedures for evaluating rating scales using the Partial Credit Model (see Chapter 5).
