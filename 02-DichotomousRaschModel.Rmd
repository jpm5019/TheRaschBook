...
[Cheng - Okay, please delete this screenshot.]
...
We can examine the achievement data frame by clicking on it in the *Environment* pane of R Studio. 
...
# Note: SW needs to update to include centering...
uncentered.item.locations_JMLE <- jmle.dichot.transreas$xsi
centered.item.locations_JMLE <- scale(uncentered.item.locations_JMLE, scale = FALSE)
summary(centered.item.locations_JMLE)

centered.item.locations_JMLE
...
## Example Results Section based on the MMLE results:
