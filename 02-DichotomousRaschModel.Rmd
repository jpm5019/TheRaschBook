...
Try to estimate item and person locations with the dichotomous Rasch model for the Chapter 2 Exercise data using any of the estimation procedures used in this chapter. Then, try writing a results section similar to the example in this chapter based on your findings.
