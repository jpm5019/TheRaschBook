...
Table 3 includes detailed results for first 10 students who participated in the Transitive Reasoning Test. For each student, the average rating is presented, followed by their logit-scale location estimate (*θ*), *SE*, and model-data fit statistics. 
...
## Exericise
Please use the eRm or TAM package to estimate item, threshold, and person locations with the RSM for the Exercise 4 data. Then, try writing a results section similar to the example in this chapter based on your findings.
...
## Exericise
Please use the TAM package to estimate item and person locations with the dichotomous Rasch model for the Exercise 1 data. Then, try writing a results section similar to the example in this chapter based on your findings.
