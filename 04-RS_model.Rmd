...
## Rating Scale Model Analysis with Conditional Maximum Likelihood Estimation in eRm

In the next section, we provide a step-by-step demonstration of a RSM analysis using the *Extended Rasch Modeling*, or *eRm* package (Mair et al., 2020). We encourage readers to use the example data set that is provided in the online supplement to conduct the analysis along with us.
...
### Item Response Functions (Rating Scale Category Probability Plots)
...
## Rating Scale Model Analysis with Marginal Maximum Likelihood Estimation in TAM
...
## Rating Scale Model Analysis with Joint Maximum Likelihood Estimation in TAM
