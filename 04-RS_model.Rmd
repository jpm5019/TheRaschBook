...
Next, we will calculate standard errors for each item and threshold location. We will store them in new objects and use *summary()* to examine descriptive statistics for these values.
