...
- Rasch, George. "Critical eigenvalue sizes in standardized residual principal components analysis." *Rasch Measurement Transactions* 19, 2005, 1012.
...
# The code below will produce plots of standardized residuals for each of the items:
